...
UPDATE usuario SET nombre = 'JEFE TECNOLOGIA'    WHERE id_user = 'US-0012' AND rol = 'JEFE INMEDIATO';
UPDATE usuario SET nombre = 'JEFE PROYECTOS'     WHERE id_user = 'US-0013' AND rol = 'JEFE INMEDIATO';
UPDATE usuario SET nombre = 'JEFE TESORERIA'     WHERE id_user = 'US-0014' AND rol = 'JEFE INMEDIATO';
...
UPDATE usuario SET nombre = 'JEFE FINANCIERA'    WHERE id_user = 'US-0019' AND rol = 'JEFE INMEDIATO';
