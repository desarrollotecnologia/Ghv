...
CREATE TABLE IF NOT EXISTS solicitud_permiso (
    ...
    permiso_remunerado TINYINT(1) NULL COMMENT '1=Sí, 0=No',
    permiso_no_remunerado TINYINT(1) NULL COMMENT '1=Sí, 0=No',
    hora_inicio TIME NULL,
    hora_fin TIME NULL,
    correo_resolucion_enviado TINYINT(1) NULL COMMENT '1=envíado, 0=no enviado',
    correo_resolucion_at DATETIME NULL COMMENT 'Cuándo se envió el correo de resolución',
...
CREATE TABLE IF NOT EXISTS solicitud_incapacidad (
    ...
    origen_atencion ENUM('EPS','ARL','ACCIDENTE_TRANSITO') NULL,
...
INSERT INTO perfil_ocupacional (id_perfil, area_id, perfil_ocupacional, presupuestados) VALUES
    ...
    ('e8f1a2b3', (SELECT a.id FROM area a JOIN departamento d ON a.departamento_id=d.id WHERE a.nombre='TECNOLOGIA' AND d.nombre='DPTO JURIDICO Y GESTION HUMANA'), 'ANALISTA TIC', NULL),
...
-- Telemetría / auditoría (estadísticas de ingreso al sistema)
