...
AREA_ALIASES: dict[str, list[str]] = {
    ...
    "CONTROLLER": ["CONTROL INTERNO", "DIRECCION CONTROLLER", "CONTROLLER"],
...
DIRECTORIO_FALLBACK: list[dict[str, str]] = [
    ...
    {"departamento": "DPTO ADMON Y FINANCIERO", "area": "PLANEACION FINANCIERA", "jefe": "Jefe de Planeacion Financiera", "email": "direccion.proyectos@colbeef.com"},
    ...
    {"departamento": "CONTROLLER", "area": "CONTROLLER", "jefe": "Director Controller", "email": "gerencia.operaciones@colbeef.com"},
    ...
    {"departamento": "DPTO DE OPERACIONES", "area": "AMBIENTAL", "jefe": "Lider Ambiental", "email": "coordinacion.ambiental@colbeef.com"},
    {"departamento": "DPTO DE OPERACIONES", "area": "PTAR", "jefe": "Lider Ambiental", "email": "coordinacion.ambiental@colbeef.com"},
    {"departamento": "DPTO DE OPERACIONES", "area": "PTAP", "jefe": "Lider Ambiental", "email": "coordinacion.ambiental@colbeef.com"},
    {"departamento": "DPTO CALIDAD", "area": "LIMPIEZA Y DESINFECCION", "jefe": "Supervisor LyD", "email": "coordinacion.lyd@colbeef.com"},
    {"departamento": "DPTO DE OPERACIONES", "area": "SST", "jefe": "Lider SST", "email": "siso@colbeef.com"},
    ...
    {"departamento": "DPTO COMERCIAL", "area": "PLANILLAJE, CAJA Y PESAJE", "jefe": "Director Comercial", "email": "gerencia.comercial@colbeef.com"},
